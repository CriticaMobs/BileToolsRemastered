...
public class BileUtils
{
	...
	public static Set<File> unload(Plugin plugin)
	{
		...
		File ff = new File(new File(BileTools.getInstance ().getDataFolder(), "temp"), idx);
		System.gc();
	...
	{
		return new File(new File(BileTools.getInstance ().getDataFolder(), "library"), p.getName());
	}

	public static File getBackupLocation(String n)
	{
		return new File(new File(BileTools.getInstance ().getDataFolder(), "library"), n);
	}
	...
	{
		return BileTools.getInstance ().getDataFolder().getParentFile();
	}
